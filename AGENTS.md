...
- **Phase gates.** After each phase, run the checks in `docs/phase-gates-and-prs.md` (in this plugin repo). Consider opening a PR after Phase 2b, 3b, 4, or 4f if a reviewer is available.
